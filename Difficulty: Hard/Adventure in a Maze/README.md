<h2><a href="https://www.geeksforgeeks.org/problems/adventure-in-a-maze2051/1?page=2&difficulty=Hard&sortBy=difficulty">Adventure in a Maze</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You have got&nbsp;a maze, which is a n*n&nbsp;Grid. Every cell of the maze contains these numbers 1, 2 or 3.&nbsp;<br>
